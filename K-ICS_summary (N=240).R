...
stable <-
  rbind(c(colMeans(prd240_ggl), colMeans(prd240_ggl)[1:5]-colMeans(prd240_ggl)[6]),
        c(colMeans(prd240_ggm), colMeans(prd240_ggm)[1:5]-colMeans(prd240_ggm)[6]),
        c(colMeans(prd240_ggh), colMeans(prd240_ggh)[1:5]-colMeans(prd240_ggh)[6]),
        c(colMeans(prd240_a4l), colMeans(prd240_a4l)[1:5]-colMeans(prd240_a4l)[6]),
        c(colMeans(prd240_a4m), colMeans(prd240_a4m)[1:5]-colMeans(prd240_a4m)[6]),
        c(colMeans(prd240_a4h), colMeans(prd240_a4h)[1:5]-colMeans(prd240_a4h)[6]),
        c(colMeans(prd240_t4l), colMeans(prd240_t4l)[1:5]-colMeans(prd240_t4l)[6]),
...
save.image("K-ICS_summary (N=240).RData")
