...
for (i in 1:J) {
  ...
  pc2v60.risk_life <- pc2v60.risk_life - mean(pad60.risk_life)
  pc2v60.risk_pnc  <- qnorm(    pc2v60.cop[,2], sd   =est60.parm_pnc[2], mean=est60.parm_pnc[1])
  pc2v60.risk_pnc  <- pc2v60.risk_pnc  - mean(pad60.risk_pnc)
  pc2v60.risk_cred <- qnorm(    pc2v60.cop[,3], sd   =est60.parm_cred[2], mean=est60.parm_cred[1])
  pc2v60.risk_cred <- pc2v60.risk_cred  - mean(pad60.risk_cred)
  pc2v60.risk_mkt  <- qnorm(    pc2v60.cop[,4], sd   =est60.parm_mkt[2], mean=est60.parm_mkt[1])
...
save.image("K-ICS_analysis2 (J=2000, true=g cop, g dist, high cor, N=60).RData")
